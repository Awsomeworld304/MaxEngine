...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MaxEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MaxEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "JamesTech";
		app.meta["file"] = "MaxEngine";
		app.meta["name"] = "Max Engine";
